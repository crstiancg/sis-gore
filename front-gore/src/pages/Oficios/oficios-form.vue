<template>
    ...
    <q-card class="my-card">
      ...
      <q-form @submit.prevent="submit">
        <q-card-section class="q-pa-md">
          <q-input dense outlined v-model="form.nombre" :loading="form.validating" label="Nombre *" @change="form.validate('nombre')" :error="form.invalid('nombre')" :class="form.invalid('nombre') ? 'q-mb-sm' : ''" >
  ...
  let form;
  if (props.edit) {
    form = useForm("put", "api/oficios/" + props.id, {
      id: "",
      nombre: "",
  
    });
  } else {
    form = useForm("post", "api/oficios", {
      id: "",
      nombre: "",
    });
  }
