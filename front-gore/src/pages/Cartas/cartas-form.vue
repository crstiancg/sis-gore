      ...
      <q-card-section class="q-pa-md">
        ...
        <div class="row q-mt-md">
          <SelectInput
            ...
            :options="ProcedimientoService"
            OptionValue="idprocedim"
            OptionLabel="desprocedim"
            :requerido="true"
          ></SelectInput>
          <q-input
            dense
            ...
            label="Monto *"
            @change="form.validate('monto')"
            :error="form.invalid('monto')"
            :class="form.invalid('monto') ? 'q-mb-sm' : ''"
          >
            <template v-slot:prepend><q-icon name="mdi-key" /></template>
            <template v-slot:error>
              <div>{{ form.errors.monto }}</div>
            </template>
          </q-input>
          <q-input
            dense
            ...
            :loading="form.validating"
            label="Dependencia *"
            @change="form.validate('dependencia')"
            :error="form.invalid('dependencia')"
            :class="form.invalid('dependencia') ? 'q-mb-sm' : ''"
          >
            <template v-slot:prepend><q-icon name="mdi-key" /></template>
            <template v-slot:error>
              <div>{{ form.errors.dependencia }}</div>
            </template>
          </q-input>
          <q-input
            dense
            ...
            :loading="form.validating"
            label="Contratista *"
            @change="form.validate('contratista')"
            :error="form.invalid('contratista')"
            :class="form.invalid('contratista') ? 'q-mb-sm' : ''"
          >
            <template v-slot:prepend><q-icon name="mdi-key" /></template>
            <template v-slot:error>
              <div>{{ form.errors.contratista }}</div>
            </template>
          </q-input>
        </div>
        <div class="row">
          <q-input
            ...
            :loading="form.validating"
            label="Denominacion *"
            @change="form.validate('denominacion')"
            :error="form.invalid('denominacion')"
            :class="form.invalid('denominacion') ? 'q-mb-sm' : ''"
          >
            <template v-slot:prepend><q-icon name="mdi-key" /></template>
            <template v-slot:error>
              <div>{{ form.errors.denominacion }}</div>
            </template>
          </q-input>
        </div>
      </q-card-section>
